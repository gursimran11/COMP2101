...
### this file will retrive data of the system.
# retrives system hardware data
...
#displays result for network
Write-Output "  "
Write-Output "  "
Write-Output "SYSTEM INFORMATION REPORT" 

Write-Output "RETRIVED IP CONFIGURATION DATA"
Retrive-IPconfiguration.ps1
